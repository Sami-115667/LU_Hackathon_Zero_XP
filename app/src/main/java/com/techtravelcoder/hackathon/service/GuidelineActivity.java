...
import com.techtravelcoder.hackathon.adapter.GuidelineAdapter;
...
public class GuidelineActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mbase = FirebaseDatabase.getInstance().getReference("Teacher Info").child("Guideline");
        recyclerView.setLayoutManager(new LinearLayoutManager(this));
        guidelineAdapter=new GuidelineAdapter(this,itemlist,uid1);
    ...
    private void filter(String text){
        ...
        guidelineAdapter.filterList((ArrayList<TeacherModel>) filterListUni, (ArrayList<TeacherModel>) filterListDept);
    }
